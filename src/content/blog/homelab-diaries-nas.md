...
The other drive came from my old daily driver, a [Dell Inspiron, which is the very machine Proxmox](https://eliyahukyalley.dev/blog/homelab-diaries-in-the-beginning/) now runs on. The Dell was always on anyway, so it made sense to put it to work.
